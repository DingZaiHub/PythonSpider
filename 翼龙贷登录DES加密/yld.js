...
code.google.com/p/crypto-js/wiki/License
*/
// 经过调试，原先CryptoJS.mode没有ECB对象，下面这段代码通过全局搜索CryptoJS.mode.ECB所得
// 还有一种方式是：在浏览器的console中输入CryptoJS.mode.ECB，然后查看其中的函数，找到不同的JS文件即可
...
console.log(encryptByDES("222222"))
